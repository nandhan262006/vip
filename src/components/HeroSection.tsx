...
export default function HeroSection({ heroTitle, heroSubtitle, whatsapp = '919299950999' }: { heroTitle?: string; heroSubtitle?: string; whatsapp?: string }) {
